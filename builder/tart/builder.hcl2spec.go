...
type FlatConfig struct {
	...
	KeepRecoveryPartition     *bool             `mapstructure:"keep_recovery_partition" cty:"keep_recovery_partition" hcl:"keep_recovery_partition"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"keep_recovery_partition":      &hcldec.AttrSpec{Name: "keep_recovery_partition", Type: cty.Bool, Required: false},
