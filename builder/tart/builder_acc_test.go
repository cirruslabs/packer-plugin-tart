...
// Run with: PACKER_ACC=1 go test -count 1 -v ./builder/tart/builder_acc_test.go  -timeout=120m
func TestAccScaffoldingBuilder(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "tart_builder_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Check: func(buildCommand *exec.Cmd, logfile string) error {
			...
			buildGeneratedDataLog := "tart-my-builder.basic-example: build generated data: mock-build-data"
