...
@include 'packer-plugin-sdk/common/bootcommand/BootConfig.mdx'

#### Optional:

@include 'packer-plugin-sdk/common/bootcommand/BootConfig-not-required.mdx'
...
@include 'packer-plugin-sdk/common/bootcommand/VNCConfig.mdx'

#### Optional:

@include 'packer-plugin-sdk/common/bootcommand/VNCConfig-not-required.mdx'
